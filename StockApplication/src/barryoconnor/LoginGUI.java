...
public class LoginGUI extends javax.swing.JFrame {
     ...
     * @param parent
     */
    public LoginGUI(StockMarketApplication parent) {
        mParent = parent;
        initComponents();
            ...
            SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    ...
                    if(email.isEmpty() || password.isEmpty()){
                        ...
                        String response = userLogin(email,password);
                        ...
                        if(responseJSONObj.getBoolean("result")){
                            ...
                            if(errorMsg.equalsIgnoreCase("INVALID_PASSWORD")||errorMsg.equalsIgnoreCase("EMAIL_NOT_FOUND")){
                                lblError.setText("<html>Invalid Credentials - please try again</html>");
                            } else {
    ...
    private static String userLogin(java.lang.String email, java.lang.String password) {
        ...
        return port.userLogin(email, password);
    }
